...
class MultivariateTMixture:
    def __init__(self, n_components=1, max_iter=16, random_state=None, reg_covar=1e-6, tol=1e-3, init_params='kmeans'):
    ...
    def fit(self, X):
        ...
        for _ in range(self.max_iter):
            ...
            self.lower_bound = np.mean(log_prob_norm)
            likelihood.append(self.lower_bound)
